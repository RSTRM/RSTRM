...
export default class RestroomView extends React.Component {
  render() {
    return (
        ...
        <Block flex>
          ...
          //will connect data-image to source field below here
            ...
            <Block flex style={styles.profileDetails}>
              ...
              {/* {will connect restroom name to text field below} */}
                <Text color="white" size={28} style={{ paddingBottom: 36 }} >
                    Restroom 1</Text>
                <Block row space="between">
                  <Block row>
                    <Block middle style={styles.pro}>
                      <Text size={16} color="black">Pro</Text>
                    </Block>
                    <Text color="black" size={16} muted style={styles.seller}>Establishment</Text>
                    <Text size={16} color={materialTheme.COLORS.WARNING}>
                      4.9 <Icon name="shape-star" family="GalioExtra" size={14} />
                    </Text>
                  </Block>
                  <Block>
                    <Text color={theme.COLORS.MUTED} size={16}>
                      <Icon name="map-marker" family="font-awesome" color={theme.COLORS.MUTED} size={16} style={{ paddingBottom: 33 }} />
                      {` `} New York, NY
                      </Text>
                  </Block>
                </Block>
          ...
          <ScrollView showsVerticalScrollIndicator={false}>
            <Block row space="between" style={{ padding: theme.SIZES.BASE, }}>
              <Block middle>
                ...
                <Text muted size={12}>Reviews</Text>
              </Block>
              <Block middle>
                <Text bold size={12} style={{marginBottom: 8}}>5</Text>
                <Text muted size={12}>Stars</Text>
              </Block>
              <Block middle>
                <Text bold size={12} style={{marginBottom: 8}}>2</Text>
                <Text muted size={12}>Add Review</Text>
              </Block>
            </Block>
            ...
            <Block  style={{ paddingBottom: -HeaderHeight * 2 }}>
              ...
              <Text size={16}>"Theres mouth wash and they have mints too!"</Text>
